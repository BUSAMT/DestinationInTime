    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destDescription', models.CharField(max_length=20)),
                ('destAddress', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dateTravel', models.CharField(max_length=100)),
                ('userBudget', models.CharField(max_length=100)),
